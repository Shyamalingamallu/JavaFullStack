...
<body>
  ...
  <h3 align="center" style="color: black">New Customer Account, Customer Details</h3>
  <h4 align="center" style="color: black"> <c:out value="${customerdetailserrmsg}"></c:out> </h4>
